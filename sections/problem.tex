...
artigo é um \enquote{subconjunto} do tema de
alocação e roteamento de onda tratado nas referências citadas.
...
caixas, as fibras geralmente são \enquote{espelhadas}. Uma alocação de fibras ótima
...
perdem o \enquote{espelhamento}, porém note que os sinais retornam para o mesmo índice
...
Outro ponto de relevância na elaboração de qualquer algoritmo para tratar de
problemas similares ao do presente artigo, é o fato de que alocação de fibras é
um problema NP-completo. É trivial comprovar isso, pois da mesma forma que o
problema do caixeiro-viajante \cite{lawler1985travelling} é fatorial com cada
cidade adicionada, para cada par de fibra adicionado, as combinações crescem em
