...
fibra dada uma rede em funcionamento, ou seja, o roteamento de backbones em uma
rede óptica \textit{mesh} com diversos nós e rotas intermediárias, coexistindo
com várias tecnologias, diferente de um enlace único OPGW (\textit{Optical
  Ground Wire}).
