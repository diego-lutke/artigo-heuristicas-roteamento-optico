...
auxiliar na automação do processo de alocação de fibras ópticas e
...
integração com ferramentas de gestão de rede óptica. Além disso, recomenda-se a
incorporação de restrições adicionais (exemplo: atenuação, capacidade dos nós,
distância máxima), a aplicação de técnicas híbridas com programação linear
inteira para otimização global, a extensão do uso para ponto-multiponto e a
inclusão de nós de conversão de onda, e também a consideração de rotas
\enquote{ocultas}, como por exemplo em \textit{swaps} feitos com outras operadoras.
